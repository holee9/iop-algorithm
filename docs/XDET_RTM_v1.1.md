...
- 고아 없음: MR 10 / PR 17 / FR 28 / EV 16 / VV 16 / TC 26 전 계층 연결 (프레임워크 FR-C015/VV-000/TC-000 포함). dSNRn 정련행은 기존 FR-N001·EV-301·VV-011·TC-018을 재사용하므로 신규 ID 카운트 증가 없음.
- Gen 1 범위(P1 대상): 예약 3행 제외 14 요구행 + dSNRn 정련행 1(신규 ID 없음, EV-301 체인 하위) — 전부 TC까지 충전 완료.
...
- **§1.4 DQE 측정 텍스트 정정 (issue #38, SPEC-DQEDOC-001)**: 측정 프로토콜 §1.4의 DQE 공식을 IEC 62220-1 무차원 형태로 정정한 것은 **측정 방법 텍스트를 이미 정확한 코드(`metrics/dqe.py`, 커밋 `41ec640`)에 정합**시킨 것으로, 요구·EV·TC·행을 바꾸지 않는다 — MR-003/PR-CORE-001 DQE 매핑(FR-C001~C004 → EV-101 → VV-001 → TC-001~003) 불변, **RTM 버전 불변**. SPEC-METRICS-001 v0.2.0이 이연한 §1.4 불일치(dqe.py `@MX:WARN` "issue #2")의 종결.
